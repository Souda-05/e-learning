      ...
      >
        <div className="container flex justify-between items-center py-6 bg-primary/10">
          ...
          <div className="hidden lg:block space-x-6">
            <Link to="/sign-in">
              <button className="font-semibold hover:!scale-110 hover:!shadow-xl duration-300">
                Sign in
              </button>
            </Link>
            <Link to="/register">
              <button className="text-white bg-secondary font-semibold rounded-full px-6 py-2 hover:!scale-110 hover:!shadow-xl duration-300">
                Register
              </button>
            </Link>
          </div>
